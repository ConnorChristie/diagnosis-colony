...
export class StoriesComponent {
  ...
  public stories: IStoryHeader[] = [{
    author: 'Peter Giles',
    description: 'Ever wanted to connect external services to your Ghost site and create seamless automation between them? Now you can, with our new and official integration with Zapier.',
    category: 'Physical',
    link: '/',
    image: 'https://blog.ghost.org/content/images/2018/01/ghostzapimg--3-.jpg',
    ...
    researchers: [{
      ...
      name: 'Hannah Wolfe',
      image: '//www.gravatar.com/avatar/49ebcbbe9bb3ed1f5d5de91483de383c?s=250&amp;d=mm&amp;r=x',
      link: '/'
    }]
  }, {
    author: 'Peter Giles',
    ...
    category: 'Physical',
    link: '/',
    image: 'https://blog.ghost.org/content/images/2017/11/DSCF1207-Edit--2-.jpg',
  ...
  get cards(): IPostCardDetails[] {
    return this.stories.map(story => ({
      ...
      participants: story.researchers
    }));
  }
